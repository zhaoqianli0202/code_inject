...
aarch64-linux-gnu-gcc -fPIC test.cpp -I/home/qianli.zhao/matrix5/out/debug-gcc_9.3-64/target/rootfs/include/ -L/home/qianli.zhao/matrix5/out/debug-gcc_9.3-64/target/deploy/system/lib -L./ -Wl,-dynamic-list,dynsym.syms -ltest_lib -lalog -o test.elf
